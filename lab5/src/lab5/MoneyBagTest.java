...
public class MoneyBagTest extends TestCase {
    ...
    public void testMoneyBagEquals() {
    	...
    	// Test MoneyBag = MoneyBag
        assertTrue(fMB1.multiply(0).equals(fMB2.multiply(0)));


        // isZero, not instance of IMoney
        int temp_money = 0;
        assertFalse(fMB1.multiply(0).equals(temp_money));
    ...
    public void testMoneyEquals() {
        ...
        // isZero, instance of IMoney
        assertTrue(f12CHF.multiply(0).equals(fMB1.multiply(0)));
        
        // isZero, not instance of IMoney
        assertFalse(f12CHF.multiply(0).equals(null));
